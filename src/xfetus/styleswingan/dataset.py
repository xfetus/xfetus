...
def getDataset(plane_name, data_path='data_path', size=256, show_img=False):
    ...
    lst = np.load(f'{plane_name}.npy', allow_pickle=True)
    training_data = ImageDataset(lst, transforms, data_path)
